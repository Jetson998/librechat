...
# release-governance:targets=LibreChat-API,LibreChat-CodeAPI,chat-mongodb
...
patch_root="deployment/production-patches/2026-07-22-visible-artifact-limit"
remote_stage="/tmp/librechat-visible-artifact-limit-${RELEASE_SOURCE_REVISION:0:12}"

for file in \
  "$patch_root/office-context-patch/BaseClient.js" \
  "$patch_root/office-context-patch/GeneratedArtifactVisibility.js" \
...
export LIBRECHAT_BASECLIENT_SRC="$patch_root/office-context-patch/BaseClient.js"
export LIBRECHAT_VISIBILITY_SRC="$patch_root/office-context-patch/GeneratedArtifactVisibility.js"
