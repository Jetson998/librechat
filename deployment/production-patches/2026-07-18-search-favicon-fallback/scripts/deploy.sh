...
stage_dir="${1:-/tmp/librechat-search-favicon-fallback}"
...
source_client="$root_dir/user-usage-cost-detail-availability/72075ad1a389-20260718221835/client-dist"
source_usage_route="$root_dir/user-usage-cost-detail-availability/72075ad1a389-20260718221835/usage-dashboard.js"
release_root="$root_dir/search-favicon-fallback/$release_key-$timestamp"
release_client="$release_root/client-dist"
backup_dir="$root_dir/backups/search-favicon-fallback-$timestamp"
asset_dir="$stage_dir/client"
search_asset="search-favicon-fallback-$release_key.js"
release_test="$stage_dir/scripts/test-release.py"
client_builder="$stage_dir/scripts/build-client.py"
work_dir="$(mktemp -d /tmp/librechat-search-favicon-fallback.XXXXXX)"
candidate_client="$work_dir/client-dist"
candidate_override="$work_dir/compose.override.yaml"

expected_override_sha="cb932ad87bfb18469d0c883d4825377aae76ab67bb5b024be7228cfcb83a0582"
expected_index_sha="68b0f7dcbe8822ec3a786569994bc573bc76f79187ef83efaa69c6cac8b3725f"
...
for path in \
  ...
  "$source_usage_route" "$expected_pricing_bundle" \
  ...
  "$source_client/context-safety-ui.css" "$asset_dir/search-favicon-fallback.js" \
...
test "$(sha_file "$asset_dir/search-favicon-fallback.js")" = "$expected_search_asset_sha"
...
install -m 0444 "$asset_dir/search-favicon-fallback.js" "$candidate_client/$search_asset"
python3 "$client_builder" "$candidate_client/index.html" "$search_asset"

test "$(grep -cF 'id="search-favicon-fallback"' "$candidate_client/index.html")" = "1"
...
grep -Fq 'user-usage-dashboard.js?v=72075ad1a389' "$candidate_client/index.html"
...
curl -ksSf -o "$work_dir/live-context.js" https://152.32.172.162.sslip.io/context-safety-ui.js
curl -ksSf -o "$work_dir/live-context.css" https://152.32.172.162.sslip.io/context-safety-ui.css
...
grep -Fq 'user-usage-dashboard.js?v=72075ad1a389' "$work_dir/live-index.html"
grep -Fq 'context-safety-ui-9fa04abc07e9.js' "$work_dir/live-index.html"
...
test "$(sha_file "$work_dir/live-context.js")" = "$expected_context_script_sha"
test "$(sha_file "$work_dir/live-context.css")" = "$expected_context_style_sha"
