...
remote_stage="/tmp/librechat-agent-category-dedup-count-fix-preflight-${source_revision:0:12}"
remote_raw="$remote_stage/runtime-raw.json"
local_raw="$(mktemp "${TMPDIR:-/tmp}/librechat-agent-category-dedup-count-fix-runtime.XXXXXX")"
...
raw.update(
    {
        ...
        "client_artifact": {
            ...
            "build_source_revision": metadata["build_provenance"]["source_revision"],
