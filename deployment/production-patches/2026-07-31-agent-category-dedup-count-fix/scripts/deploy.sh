...
patch_root="deployment/production-patches/2026-07-31-agent-category-dedup-count-fix"
...
remote_stage="/tmp/librechat-agent-category-dedup-count-fix-deploy-${RELEASE_SOURCE_REVISION:0:12}"
