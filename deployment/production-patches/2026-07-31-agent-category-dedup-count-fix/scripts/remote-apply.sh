...
release_root="$root_dir/agent-category-dedup-count-fix/${source_revision:0:12}-$timestamp"
release_client="$release_root/client-dist"
backup_dir="$root_dir/backups/agent-category-dedup-count-fix-${source_revision:0:12}-$timestamp"
work_dir="$(mktemp -d /tmp/librechat-agent-category-dedup-count-fix-apply.XXXXXX)"
