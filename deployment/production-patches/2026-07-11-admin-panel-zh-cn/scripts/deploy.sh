...
upload_menu_dist="$root_dir/user-model-market/6bfb5be23255-20260718235639/client-dist"
...
grep -Fq '/opt/librechat/user-model-market/6bfb5be23255-20260718235639/client-dist:/app/client/dist:ro' "$candidate_override"
