...
const RESOURCES = [
  ...
  {
    titleKey: 'com_help_source_title',
    descKey: 'com_help_source_desc',
    icon: 'code',
    href: 'https://github.com/Jetson998/librechat/tree/main/deployment/production-patches/2026-07-11-admin-panel-zh-cn/source',
  },
] as const;
