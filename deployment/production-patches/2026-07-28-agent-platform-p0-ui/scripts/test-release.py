...
def load_verifier():
    ...
    spec = importlib.util.spec_from_file_location("agent_ui_artifact_verifier", path)
...
def main() -> None:
    ...
    check(len(metadata["artifact"]["members"]) == 4, "artifact member contract changed")
    ...
    print("agent_platform_p0_ui_release_contract=passed")
