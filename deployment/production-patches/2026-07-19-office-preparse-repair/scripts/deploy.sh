...
remote_stage="/tmp/librechat-office-preparse-repair-${RELEASE_SOURCE_REVISION:0:12}"
patch_root="deployment/production-patches/2026-07-19-office-preparse-repair/office-context-patch"
release_root="deployment/production-patches/2026-07-19-office-preparse-repair/scripts"
