...
release_root="$root_dir/preset-agent-contact-visibility/${source_revision:0:12}-$timestamp"
release_client="$release_root/client-dist"
backup_dir="$root_dir/backups/preset-agent-contact-visibility-${source_revision:0:12}-$timestamp"
work_dir="$(mktemp -d /tmp/librechat-agent-contact-visibility-apply.XXXXXX)"
