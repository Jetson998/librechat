...
patch_root="deployment/production-patches/2026-07-29-preset-agent-contact-visibility"
...
remote_stage="/tmp/librechat-agent-contact-visibility-deploy-${RELEASE_SOURCE_REVISION:0:12}"
