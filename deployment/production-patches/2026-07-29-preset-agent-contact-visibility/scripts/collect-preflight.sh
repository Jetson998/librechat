...
remote_stage="/tmp/librechat-agent-contact-visibility-preflight-${source_revision:0:12}"
remote_raw="$remote_stage/runtime-raw.json"
local_raw="$(mktemp "${TMPDIR:-/tmp}/librechat-agent-contact-visibility-runtime.XXXXXX")"
