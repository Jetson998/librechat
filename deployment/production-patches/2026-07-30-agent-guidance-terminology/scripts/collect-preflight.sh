...
remote_stage="/tmp/librechat-agent-guidance-terminology-preflight-${source_revision:0:12}"
remote_raw="$remote_stage/runtime-raw.json"
local_raw="$(mktemp "${TMPDIR:-/tmp}/librechat-agent-guidance-terminology-runtime.XXXXXX")"
