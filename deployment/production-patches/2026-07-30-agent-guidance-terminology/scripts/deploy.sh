...
patch_root="deployment/production-patches/2026-07-30-agent-guidance-terminology"
...
remote_stage="/tmp/librechat-agent-guidance-terminology-deploy-${RELEASE_SOURCE_REVISION:0:12}"
