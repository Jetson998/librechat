...
patch_root="deployment/production-patches/2026-09-03-reasoning-intensity-session"
...
remote_stage="/tmp/librechat-reasoning-intensity-session-deploy-${RELEASE_SOURCE_REVISION:0:12}"
