...
remote_stage="/tmp/librechat-agent-sidebar-menu-preflight-${source_revision:0:12}"
remote_raw="$remote_stage/runtime-raw.json"
local_raw="$(mktemp "${TMPDIR:-/tmp}/librechat-agent-sidebar-menu-runtime.XXXXXX")"
...
raw.update(
    {
        ...
        "client_artifact": {
            ...
            "artifact_id": metadata["github_actions"]["artifact_id"],
