...
release_root="$root_dir/agent-sidebar-menu-state/${source_revision:0:12}-$timestamp"
release_client="$release_root/client-dist"
backup_dir="$root_dir/backups/agent-sidebar-menu-state-${source_revision:0:12}-$timestamp"
work_dir="$(mktemp -d /tmp/librechat-agent-sidebar-menu-apply.XXXXXX)"
