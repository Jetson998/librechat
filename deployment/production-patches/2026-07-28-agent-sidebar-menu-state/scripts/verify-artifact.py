#!/usr/bin/env python3
"""Verify the immutable Agent sidebar Client artifact without extracting it."""
...
def verify(artifact_zip: Path, metadata_path: Path) -> dict:
    ...
    require(
        sidebar_manifest["patch"]["sha256"] == source["follow_up_patch_sha256"],
    ...
    return {
        ...
        "follow_up_patch_sha256": source["follow_up_patch_sha256"],
