...
patch_root="deployment/production-patches/2026-07-28-agent-sidebar-menu-state"
...
remote_stage="/tmp/librechat-agent-sidebar-menu-deploy-${RELEASE_SOURCE_REVISION:0:12}"
