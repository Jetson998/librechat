...
patch_root="deployment/production-patches/2026-07-22-fable-tool-endpoint-aliases"
remote_stage="/tmp/librechat-fable-tool-alias-${RELEASE_SOURCE_REVISION:0:12}"
