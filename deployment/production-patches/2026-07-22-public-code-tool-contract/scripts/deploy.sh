...
patch_root="deployment/production-patches/2026-07-22-public-code-tool-contract"
remote_stage="/tmp/librechat-public-code-tool-contract-${RELEASE_SOURCE_REVISION:0:12}"
