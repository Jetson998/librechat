...
remote_stage="/tmp/librechat-preset-agent-deploy-${RELEASE_SOURCE_REVISION:0:12}"
...
for name in runtime_common.py remote-apply.py remote-rollback.py snapshot-targets.js seed-agents.js rollback-agents.js; do
