...
script_dir="deployment/production-operations/2026-07-29-preset-workflow-agents/scripts"
...
transport_exec "test -f '$backup_dir/remote-rollback.py' && cd '$backup_dir' && python3 ./remote-rollback.py '$backup_dir'"
