...
const { installFileAgentRuntimeHost } = require('./services/FileAgentRuntime');
...
const startServer = async () => {
  ...
  // Disabled mode performs no Runtime import, database index creation, or network work.
  // When explicitly enabled, install before the Agent router is registered below.
  await installFileAgentRuntimeHost({ app, appConfig });
  ...
  app.use('/api/admin/diagnostic-events', routes.adminDiagnosticEvents);
